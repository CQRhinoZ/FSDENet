...
parser.add_argument('--resume', '-r', default='/home/daiyr/Daily/D-Code-Best/save_model/sysu_fuxian_best.t', type=str,
...
if dataset == 'sysu':
    ...
    data_path = '/home/daiyr/Data/RegDB/'
    n_class = 206
    test_mode = [1, 2]
    # test_mode = [2,1]
    pool_dim = 1024 * (part_nums + 1)
elif dataset == 'llcm':
...
net = embed_net(n_class, dataset, arch=args.arch, part_num=part_nums)
